...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun  9 15:40:09 2023
...
study = optuna.create_study(direction="maximize", sampler=optuna.samplers.TPESampler(seed=1234), pruner=optuna.pruners.MedianPruner())
...
f = open('./experiment_results/brits_results.txt', 'w')
f.write(str(metrics['f1']))
f.close()
